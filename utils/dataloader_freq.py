...
from utils.hsvharr import rgb_dwt_tensor_data
import pickle
...
class TrainDataset(Dataset):
    ...
    def __init__(self, image_root, gt_root, trainsize, edge_root=True, rVFlip=True, rCrop=True, rRotate=True,
    ...
    def __getitem__(self, index):
        ...
        if self.edge_root is not None:
            ...
            return img, gt, edge, high, low, name
        else:
